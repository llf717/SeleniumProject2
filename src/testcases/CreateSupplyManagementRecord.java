...
public class CreateSupplyManagementRecord {
	...
	@Test
	public void creaeSupply() throws InterruptedException {
...
//		driver.findElement(By.xpath(".//*[@id='r1']/ul/li[5]/table/tbody/tr/td[2]")).click();
		...
		Log.info("点击 新增按钮");
		driver.findElement(By.name("pro_name")).sendKeys("签字笔");
		Log.info("输入办公用品名称");
		driver.findElement(By.name("pro_unit")).sendKeys("支");
		Log.info("输入计量单位");
		Select se = new Select(driver.findElement(By.id("_3_")));
		se.selectByVisibleText("书写修正");
		Log.info("选择 办公用品类型");
		driver.findElement(By.name("pro_supplier")).sendKeys("办公用品供应商");
		Log.info("输入供应商");
